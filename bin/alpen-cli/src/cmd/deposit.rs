...
use alpen_primitives::constants::UNSPENDABLE_PUBLIC_KEY;
use argh::FromArgs;
use bdk_wallet::{
...
pub async fn deposit(
    ...
    let mut op_return_data = [0u8; MBL + TNHL + AlpenAddress::len_bytes()];
    ...
    op_return_data[MBL + TNHL..].copy_from_slice(alpen_address.as_slice());
