...
use strata_rpc_types::{CooperativeWithdrawalInfo, DepositInfo, RpcServerError};
...
pub(crate) async fn extract_deposit_requests(
...
//         buf::Buf32,
//         l1::{
//             BitcoinAmount, DepositRequestInfo, HeaderVerificationState, L1BlockId,
// L1BlockManifest,             L1HeaderRecord, L1Tx, L1TxProof, OutputRef, RawBitcoinTx, XOnlyPk,
//         },
//     };
...
//                 "should be able to find the expected withdrawal info in the list of withdrawal
// infos"             );
//         } else {
...
//     /// 3. A flag indicating whether a non-arbitrary [`Transaction`]/[`ProtocolOperation`] pair
// was     ///    generated. The chances of an arbitrarily constructed pair being valid is extremely
// rare.     ///    So, you can assume that this flag represents whether the pair is valid (true) or
// invalid     ///    (false).
