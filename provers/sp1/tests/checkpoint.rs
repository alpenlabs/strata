...
mod test {
    ...
    use express_proofimpl_checkpoint::CheckpointProofOutput;
    ...
    fn test_checkpoint_proof() {
        ...
        let btc_prover = BtcBlockProofGenerator::new(rollup_params);
        let l1_batch_prover = L1BatchProofGenerator::new(btc_prover);
        let el_prover = ElProofGenerator::new();
        let cl_prover = ClProofGenerator::new(el_prover, rollup_params);
