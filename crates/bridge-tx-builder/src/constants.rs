...
/// The value of each UTXO in the Bridge Multisig Address. In practice, the actual value of a UTXO
/// would be slightly less due to miner/relay fees.
...
///
/// We use a slightly larger value (3000 in bitcoin-core) to cross the dust threshold.
...
lazy_static::lazy_static! {
    ...
    ///
    /// This is generated via <https://github.com/alpenlabs/unspendable-pubkey-gen> following [BIP-0341](https://github.com/bitcoin/bips/blob/master/bip-0341.mediawiki#constructing-and-spending-taproot-outputs)
