...
use super::{common::{check_magic_bytes, extract_ee_bytes, parse_bridge_offer_output}, error::DepositParseError, DepositTxConfig};
...
mod tests {
    ...
    fn check_deposit_parser() {
        ...
        let deposit_request_script = build_test_deposit_script(config.magic_bytes, evm_addr.to_vec());
