...
pub trait L1DataStore {
    ...
    /// Resets the L1fork choice tip to the specified block index.  The provided
    /// index will be the newfork choice tip that we store.
...
pub trait L1DataProvider {
    /// Gets the currentfork choice tip index.
...
/// the L2fork choice tip is, that's controlled by the consensus state.
