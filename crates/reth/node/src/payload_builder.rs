    ...
    Pool: TransactionPool,
{
    ...
    fn build_empty_payload(
        ...
        build_empty_payload(self.evm_config, client, config)
    }
}
...
fn build_empty_payload(
    ...
    config: PayloadConfig<ExpressPayloadBuilderAttributes>,
) -> Result<ExpressBuiltPayload, PayloadBuilderError> {
    ...
    let eth_build_payload = EthBuiltPayload::new(attributes.payload_id(), sealed_block, U256::ZERO);
