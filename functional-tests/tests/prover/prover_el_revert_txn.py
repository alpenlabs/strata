...
@flexitest.register
class ElRevertTxnTest(testenv.StrataTester):
    ...
    def main(self, ctx: flexitest.RunContext):
        ...
        # Deploy the contract
        abi, bytecode = SmartContracts.compile_contract("RevertContract.sol", "RevertContract")
        ...
        tx_hash = contract_instance.functions.revertTransaction().transact({"gas": 2000000})
        tx_receipt = web3.eth.wait_for_transaction_receipt(tx_hash, timeout=30)
