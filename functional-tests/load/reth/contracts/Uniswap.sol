...
contract UniswapPair {
    ...
    function swap(uint256 amount, address tokenIn) external {
        ...
        require(tokenInInstance.transferFrom(msg.sender, address(this), amount), "Transfer failed");
        require(tokenOutInstance.transfer(msg.sender, amount), "Swap transfer failed");
...
contract UniswapRouter {
    ...
    function swap(
        ...
        IERC20 tokenInInstance = IERC20(tokenIn);
        require(tokenInInstance.transferFrom(msg.sender, address(this), amount), "Token transfer failed");
