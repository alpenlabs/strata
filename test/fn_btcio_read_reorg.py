...
class L1ReadReorgTest(flexitest.Test):
    ...
    def main(self, ctx: flexitest.RunContext):
        ...
        # Wait for some blocks to be added after invalidating (n-3) blocks because poll time for sequencer is supposed to be 500ms and 2 seconds seems to be optimal for sequencer to catch changes
        time.sleep(2)
